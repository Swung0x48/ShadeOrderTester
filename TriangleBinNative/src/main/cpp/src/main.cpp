    ...
    Log(LOG_INFO) << "Entering main loop";
    {
        ...
        while (!done) {
...

            {
                ...
                ImGui::SliderFloat("Rendered/Screen Pixel %", &frag_percentage, 0, 100 * tri_count + 100);
                if (ImGui::Button("0%")) {
                    frag_percentage = 0;
                }
                ImGui::SameLine();
                ...
                ImGui::SliderInt("Tri Count", &tri_count, 0, 150);
